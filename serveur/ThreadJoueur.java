...
/*******************************************************/
	...
	/**
	 *  Renvoie la sortie de la socket
	 *
	 * @return  sortie socket
	 */
...
/********************************************************/
	...
	public void choixAdversaire(String pseudo_adv)
	{
		...
		if (serveur.existePartie(this.pseudo)==false) //vérification si le joueur n'a pas fait de proposition
		{
			if(serveur.existePartie(adv.pseudo)==false)//vérifie si l'adversaire n'a pas de demande en cours
			{
				...
				serveur.raffraichirListeAttente(adv.pseudo,0); 
	...
	/**
	 *  Cette fonction est appelée par l'AnalyseurServeur.
	 *  Elle permet d'envoyer à l'adversaire la liste des cases baissées
	 *
	 *  @param nb message envoyée par le joueur
	 */
	public void envoiCaseBaissee(String nb)
	{
		System.out.println("debut méthodeThreadjoueur envoiCaseBaissee: "+nb);
	...
	public void deconnexion()
	{
		...
		try{socket_joueur.close();}catch(IOException e){}
	}
	...
	public void envoiQuestionAuto(String num_question)
	{
		...
		adv.envoiMessageJoueur("9"+ tmp);// envoi images à baisser au joueur
	}
	...
	/**
	 *  Cette fonction est appelée par l'AnalyseurServeur.
	 *  Elle permet de choisir le mode de la partie
	 */
	public void choisirMode(String mode)
	{
		...
		adv.envoiMessageJoueur("18:"+mode);// envoi le mode à l'adversaire
	}
	
	/**
	 *  Cette fonction est appelée par l'AnalyseurServeur.
	 *  Elle permet d'envoyer l'image du mode 
	 * 
	 * @param image mode de l'image 
	 */
	...
	/**
	 *  Cette fonction est appelée par l'AnalyseurServeur.
	 *  Elle d'envoyer la liste des favoris d'une personne
	 * 
	 * @param image mode de l'image 
	 */
	...
	/**
	 *  Cette fonction est appelée par l'AnalyseurServeur.
	 *  Elle permet de quitter la partie 
	 * 
	 * @param image mode de l'image 
	 */
