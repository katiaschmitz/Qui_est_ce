...
/*******************************************************/
	...
	public static void main(String args[])
	{
		...
		/*x.bdd.inscription("omar","bla");
		x.bdd.inscription("omar2","bla");
		x.bdd.inscription("omar3","bla");
		x.bdd.inscription("omar4","bla");
		x.bdd.majScore("omar4",true);
		x.bdd.majScore("omar4",true);
		x.bdd.majScore("omar4",true);	
		x.bdd.majScore("omar4",true);
		x.bdd.majScore("omar3",false);
		x.bdd.majScore("omar3",false);*/
		x.bdd.majScore("bloulbou",true);								
	}
