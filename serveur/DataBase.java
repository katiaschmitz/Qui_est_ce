...
public class DataBase
{
	...
	/**
	 * renvoie le champ correspondant à la question dans la table image et la bonne réponse pour cette question
	 * @param  mode de la question
	 * @param id_question id de la question
	 * @return un tableau contenant le champs et la valeur
	 */
	...
	/**
	 * renvoie si l'image remplit les critères de la question
	 * @param  id_image id de l'image à vérifier
	 * @param num_champs champs de réponse à vérifier
	 * @param br bonne valeur pour la question posée
	 * @param correct savoir si la valeur de l'image doit etre egale ou différente de la bonne valeur
	 * @param m mode 
	 * @return vrai s'il faut baisser l'image, false sinon
	 */
	...
	/**
	 * recupere la valeur du champs d'une image
	 * @param  m le mode donne
	 * @param id_img id de l'image
	 * @param champ champ de réponse
	 * @return  valeur du champ pour l'image
	 */
